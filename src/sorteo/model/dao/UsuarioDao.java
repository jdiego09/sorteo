...
public class UsuarioDao extends BaseDao<Integer, Usuario> {
    ...
    public Resultado<Usuario> getUsuarioByCodigo(String codigo) {
        ...
        Usuario usuario;
        try {
            Query query = getEntityManager().createNamedQuery("Usuario.findByCodigo");
            ...
            result.setMensaje("El usuario con el código [" + codigo + "], no se encuentra registrado.");
            return result;
        } catch (Exception ex) {
    ...
    public Resultado<ArrayList<Usuario>> findUsuarios() {
    ...
    public Resultado<ArrayList<RolXUsuario>> getRolesUsuario(String usuario) {
        ...
        try {
            Query query = getEntityManager().createNamedQuery("Usuario.findRolesUsuario");
    ...
    public Resultado<String> deleteRol(RolXUsuario rolUsuario) {
        ...
        try {
            ...
            Logger.getLogger(UsuarioDao.class.getName()).log(Level.SEVERE, null, ex);
            resultado.setResultado(TipoResultado.ERROR);
            resultado.setMensaje("Error al eliminar el rol para el usuario " + rolUsuario.getUsuario().getCodigo() + ".");
            return resultado;
        }
    }
    ...
    public Resultado<Usuario> save() {
        ...
        try {            
            ...
            if (this.usuarioSistema.getCodigo() != null) {
                resultado.setResultado(TipoResultado.SUCCESS);
